  ...
  <svg viewBox="0 0 915 201" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ overflow: 'visible' }}>
    <style>
      {`
        ...
        /* HOVERS */
        svg:hover .baulia-diamond-animator { transform: rotate(90deg) scale(1.05); }
        svg:hover .baulia-diamond-shape { stroke-width: 3px; }
        svg:hover .baulia-b { transform: scale(1.08); fill: #FDF1A9; }
    ...
    {/* EL ANIMADOR (Mueve todo el diamante sin romper el viewBox) */}
    <g className="baulia-diamond-animator">
      {/* El cuadro que da el color */}
