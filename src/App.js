...
const LandingPageView = ({ isDarkMode, themeSetting, cycleTheme }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#050505] min-h-screen text-slate-900 dark:text-white transition-colors overflow-x-hidden relative font-sans">
           ...
           <div className="relative flex flex-col md:flex-row items-center md:items-start justify-between z-10">
              ...
              <div className="w-full md:w-1/2 flex items-center justify-center relative">
                 <div className="relative w-full max-w-sm h-96 flex items-center justify-center">
                    ...
                    <div className="absolute top-10 right-0 w-60 h-80 bg-slate-100 dark:bg-slate-600 rounded-2xl shadow-2xl transition-all hover:scale-105 hover:z-10 rotate-[5deg] z-0"></div>
                    <div className="w-60 h-80 bg-indigo-500 dark:bg-amber-400 rounded-2xl shadow-inner relative z-10 flex items-center justify-center text-white dark:text-slate-900 transition-colors">
                      <BauliaLogo className="h-10 w-auto opacity-70" />
                    </div>
                 </div>
              </div>
           </div>
      ...
      {/* SECCIÓN: LOS PLANES (LA COLECCIÓN) - SIN PRECIOS */}
      <div id="planes" className="py-24 px-4 max-w-7xl mx-auto z-10 relative">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-sm md:text-base transition-colors">
            Selecciona el nivel de control y tecnología que tu evento requiere. Desde lo esencial hasta el dominio absoluto.
          </p>
        </div>
