  ...
  <svg viewBox="0 0 915 201" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <style>
      {`
        ...
        /* Cuando el sistema activa el Modo Noche */
        .dark .baulia-text { fill: #FFFFFF !important; }
        .dark .baulia-diamond-bg { fill: transparent !important; }
      `}
    </style>
    
    {/* TEXTO "BAULIA" VECTORIZADO (Se adapta a la luz) */}
    ...
    {/* DIAMANTE Y B MANUSCRITA VECTORIZADA (Fija en dorado) */}
    <g>
      <rect x=".86" y=".86" width="198.64" height="198.64" transform="translate(0 200.36) rotate(-90)" className="baulia-diamond-bg" strokeMiterlimit="10" />
