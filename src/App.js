...
const LandingPageView = ({ isDarkMode, themeSetting, cycleTheme }) => {
  ...
  const demos = {
    ...
    tematicas: { id: 'tematicas', label: 'Fiestas Temáticas', url: '/demos/tematicas/index.html', desc: 'Llevamos cualquier concepto al máximo nivel con inmersión total para todas las edades.' },
